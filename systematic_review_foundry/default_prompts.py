...
DEFAULT_PROMPTS = {
    ...
    "screen_source_criteria": (
        ...
        "systematic review about {topic}. Evaluate the following paper against these "
        "inclusion/exclusion criteria:\n{criteria}\n\nReply with ONLY a Python list: "
        "[True, 'explanation'] to include, or [False, 'explanation'] to exclude. "
        "Do not include any other text. Here is the paper: {source_text}"
    ),
